...

{
	...
	if ((_position distance _posAirport < 10000) and (_position distance _posAirport > 2000) and (spawner getVariable _airport > 1) and !(_busy) and (_radio)) then {_airports pushBackUnique _airport};
