...
#define AI_TEXTS_R ["STR_UI_AIMGMT_SCV_TEXT", "STR_UI_AIMGMT_STG_TEXT", "STR_UI_AIMGMT_RST_TEXT","STR_UI_AIMGMT_DIS_TEXT"]

#define AI_TOOLTIPS_L ["STR_UI_AIMGMT_TEMP_TT", "STR_UI_AIMGMT_AH_TT", "STR_UI_AIMGMT_AR_TT", "STR_UI_AIMGMT_GARR_TT"]
#define AI_TOOLTIPS_R ["STR_UI_AIMGMT_SCV_TT", "STR_UI_AIMGMT_STG_TT", "STR_UI_AIMGMT_RST_TT", "STR_UI_AIMGMT_DIS_TT"]
...
#define VEH_TEXTS ["STR_UI_VEHMGMT_PGAR_TEXT", "STR_UI_VEHMGMT_UNL_TEXT","STR_UI_VEHMGMT_SELL_TEXT"]
#define VEH_TOOLTIPS ["STR_UI_VEHMGMT_PGAR_TT", "STR_UI_VEHMGMT_UNL_TT","STR_UI_VEHMGMT_SELL_TT"]
