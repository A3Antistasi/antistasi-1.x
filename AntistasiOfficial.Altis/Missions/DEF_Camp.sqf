...
_tsk = ["DEF_Camp",[side_blue,civilian],[[_tskDesc, _campName, _airportName], format [_tskTitle, _campName],_targetMarker],_targetPosition,"CREATED",5,true,true,"Defend"] call BIS_fnc_setTask;
...
if (_targetMarker in campsFIA) then {
	_tsk = ["DEF_Camp",[side_blue,civilian],[[_tskDesc, _campName, _airportName], format [_tskTitle, _campName],_targetMarker],_targetPosition,"SUCCEEDED",5,true,true,"Defend"] call BIS_fnc_setTask;
	...
	_tsk = ["DEF_Camp",[side_blue,civilian],[[_tskDesc, _campName, _airportName], format [_tskTitle, _campName],_targetMarker],_targetPosition,"FAILED",5,true,true,"Defend"] call BIS_fnc_setTask;
};
