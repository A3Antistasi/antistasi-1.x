...
if ((not(_tipo in guer_vehicleArray)) and (not(_tipo in var_AAF_groundForces)) and (not(_tipo in CIV_vehicles))) exitWith {hint "You are not looking to a valid vehicle"};
